...
public class Sequence extends JPanel {
    ...
    JLabel label = new JLabel("Sequence Memory");
    ...
    private Home app;
    private Sequence1 game;
    private Sequence this1;

    public Sequence(Home home) {
        app = home;
        this1 = this;
        setLayout(null);
        setSize(700, 700);
        ...
        add(button);
        label1.setBounds(300, 80, 700, 50);
